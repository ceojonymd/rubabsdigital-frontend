...
export default async function sitemap({
  ...
  if (id === 0) {
    const entries: SitemapEntry[] = [
      ...
      { url: `${SITE}/social-media`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
      { url: `${SITE}/social-media/realtors`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
      { url: `${SITE}/social-media/ecommerce`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
      { url: `${SITE}/social-media/salons`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
      { url: `${SITE}/social-media/clinics`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
      { url: `${SITE}/social-media/restaurants`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
      { url: `${SITE}/social-media/shops`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
      { url: `${SITE}/social-media/gyms`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },

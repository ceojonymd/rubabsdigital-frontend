...
const improvements = [
  "Improves perceived credibility before the first consultation.",
  "Makes practice areas and services easier to understand.",
  "Creates a cleaner path from trust into enquiry.",
];

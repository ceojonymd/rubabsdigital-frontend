...
const trustPoints = [
  "More refined service presentation and visual flow.",
  "Booking confidence through cleaner messaging.",
  "A premium feel before the client ever visits.",
];

const improvements = [
  "Makes services feel more premium and easier to browse.",
  "Supports booking intent with clearer messaging and flow.",
  "Improves trust before the first visit or message.",
];
    ...
    <main style={{ paddingTop: "80px" }}>
      <section style={{ padding: "6rem 1.5rem 2.5rem" }}>
        <div style={{ maxWidth: "1120px", margin: "0 auto" }}>
          <div style={{ color: "var(--color-accent)", fontWeight: 700, marginBottom: "0.7rem" }}>Salon Websites</div>

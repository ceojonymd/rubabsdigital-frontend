            ...
            >
              ...
              <form style={{ display: "grid", gap: "0.9rem" }}>
                <div style={{ display: "grid", gap: "0.45rem" }}>
                  ...
                  <select value={service} onChange={(e) => setService(e.target.value)} style={fieldStyle}>
                ...
                <div style={{ display: "grid", gap: "0.45rem" }}>
                  ...
                  <select value={pkg} onChange={(e) => setPkg(e.target.value)} style={fieldStyle}>
                ...
                <div style={{ display: "grid", gap: "0.45rem" }}>
                  ...
                  <select value={budget} onChange={(e) => setBudget(e.target.value)} style={fieldStyle}>
                ...
                <div style={{ display: "grid", gap: "0.45rem" }}>
                  ...
                  <select value={timeline} onChange={(e) => setTimeline(e.target.value)} style={fieldStyle}>
                    <option>ASAP</option>
                ...
                <div style={{ display: "grid", gap: "0.45rem" }}>
                  ...
                  <input placeholder="Example: law firm website refresh, local lead funnel, AI chatbot" style={fieldStyle} />
                </div>

                <div style={{ display: "grid", gap: "0.45rem" }}>
                  <label style={{ fontWeight: 700, color: "var(--color-text)" }}>Business name</label>
                  <input placeholder="Your business or brand name" style={fieldStyle} />
                </div>

                <div style={{ display: "grid", gap: "0.45rem" }}>
                  <label style={{ fontWeight: 700, color: "var(--color-text)" }}>Email</label>
                  <input type="email" placeholder="name@business.com" style={fieldStyle} />
                </div>

                <div style={{ display: "grid", gap: "0.45rem" }}>
                  <label style={{ fontWeight: 700, color: "var(--color-text)" }}>Project details</label>
                  <textarea rows={5} placeholder="Share what is not working now, what you want improved, and what kind of result you are hoping for." style={{ ...fieldStyle, resize: "vertical" }} />
                </div>
